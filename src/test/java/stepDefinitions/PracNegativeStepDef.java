...
public class PracNegativeStepDef {

    PracNegativePage pracNegativePage = new PracNegativePage();
    ...
    public void login_olmak_icin_signin_e_tiklar() {
        pracNegativePage.signinSymbol.click();
        pracNegativePage.signinButton.click();
    ...
    public void username_icin_kullanici_adini_gonderir(String username) {
        ...
        pracNegativePage.usernameBox.sendKeys(username);
    ...
    public void password_icin_parolasini_gonderir(String password) {
        ...
        pracNegativePage.passwordBox.sendKeys(password);

    }
    @When("signine tiklar")
    public void signine_tiklar() {
        pracNegativePage.siginWithCredentials.click();
    ...
    public void authentication_information_not_correct_uyarisini_dogrular() {
        ...
        wait.until(ExpectedConditions.visibilityOf(pracNegativePage.popUpMessage));
        Assert.assertTrue(pracNegativePage.popUpMessage.isDisplayed());
